...
public class RecursoController {
  ...
  public ResponseEntity addNewRecurso(@PathVariable(value = "authorId") Long authorId, 
  ...
  @ResponseStatus(HttpStatus.ACCEPTED)
  public ResponseEntity updateAutorRecurso(@RequestBody Recurso recurso, 
          @PathVariable Long authorId, @PathVariable Long recursoId) {
