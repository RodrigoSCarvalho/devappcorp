...
public class EventoController {
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity updateEventoRecurso(@PathVariable Long recursoId,
  ...
  @ResponseStatus(HttpStatus.ACCEPTED)
  public List<Evento> findEventoRecusos(@PathVariable String data_criacao, 
        @PathVariable String data_fim) {
