...
public class ColecaoController {
  ...
  @ResponseStatus(HttpStatus.CREATED)
  public ResponseEntity addNewColecaoRecurso(@RequestBody Colecao colecao,
  ...
  @ResponseStatus(HttpStatus.OK)
  public ResponseEntity updateColecaoRecurso(@PathVariable Long recursoId, 
         @PathVariable Long colecaoId, @RequestBody Colecao colecao) {
