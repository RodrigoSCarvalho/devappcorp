...
public interface EventoRepository extends JpaRepository<Evento, Long> {
  ...
  List<Evento> findEventoByDatas(@Param("data_criacao") String data_criacao, 
  ...
  @Query(value = "SELECT evento_id FROM evento WHERE evento_id NOT IN "
        + "(SELECT e.evento_id FROM evento e, recurso r WHERE e.evento_id = r.colecao_id)",
        nativeQuery = true)
