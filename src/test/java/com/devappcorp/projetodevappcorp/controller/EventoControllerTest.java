...
public class EventoControllerTest {
  ...
  public void addEventTest() throws Exception {
    ...
    MvcResult newEvent = mockMvc.perform(post("/evento")
        ...
        .content(objectMapper.writeValueAsString(event1))).andExpect(status()
        .isCreated())
        .andReturn();
  ...
  public void addEventWithExistingResourceTest() throws Exception {
    ...
    MvcResult newEvent = mockMvc.perform(post("/recurso/1/evento")
        .contentType("application/json")
        .content(objectMapper.writeValueAsString(event2))).andExpect(status()
        .isCreated())
        .andReturn();
  ...
  public void updateEventTest() throws Exception {
    ...
    MvcResult updatedEvent = mockMvc.perform(put("/evento/" + eventId)
        .contentType("application/json")
        .content(objectMapper.writeValueAsString(eventToUpdate))).andExpect(status()
        .isOk())
        .andReturn();
